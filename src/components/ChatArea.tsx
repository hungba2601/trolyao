    ...
    return (
        <div className="relative w-full h-full bg-slate-50/50">
            ...
            >
                ...
                {messages.length === 0 && (
                    <div className="flex flex-col items-center justify-center min-h-full p-4 sm:p-8 animate-in fade-in duration-500">
                ...
                {/* Messages */}
                {messages.length > 0 && (
                    <div className="max-w-4xl mx-auto py-4 px-2 sm:py-6 sm:px-4">
                        {messages.map((msg) => (
            ...
            {/* Input Area */}
            <div className="absolute bottom-0 left-0 right-0 bg-white/80 backdrop-blur-md border-t border-teal-50 p-2 sm:p-4 z-10 transition-all duration-300">
                <div className="max-w-4xl mx-auto relative group">
                    ...
                    <div className="relative flex items-end gap-1.5 sm:gap-2 p-1.5 sm:p-2 bg-white rounded-2xl shadow-sm border border-slate-200">
                        {/* Template Button */}
                        {onOpenTemplates && (
                            <button
                                onClick={onOpenTemplates}
