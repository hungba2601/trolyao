            ...
            <div className="p-4 border-t border-teal-50/50 bg-slate-50/50 backdrop-blur-sm">
                <div className="grid grid-cols-4 gap-1">
                    <button
                        ...
                        className="flex flex-col items-center justify-center p-2 hover:bg-white rounded-xl gap-1 transition-all text-slate-500 hover:text-teal-600 hover:shadow-sm border border-transparent hover:border-teal-100 group"
                    >
                    ...
                    <button
                        ...
                        className="flex flex-col items-center justify-center p-2 hover:bg-white rounded-xl gap-1 transition-all text-slate-500 hover:text-cyan-600 hover:shadow-sm border border-transparent hover:border-cyan-100 group"
                    >
                    ...
                    <button
                        ...
                        className="flex flex-col items-center justify-center p-2 hover:bg-white rounded-xl gap-1 transition-all text-slate-500 hover:text-amber-600 hover:shadow-sm border border-transparent hover:border-amber-100 group"
                    >
                    ...
                    <button
                        ...
                        className="flex flex-col items-center justify-center p-2 hover:bg-white rounded-xl gap-1 transition-all text-slate-500 hover:text-indigo-600 hover:shadow-sm border border-transparent hover:border-indigo-100 group"
                    >
                        <HelpCircle size={16} className="text-slate-400 group-hover:text-indigo-500 transition-colors" />
                        <span className="text-[10px] font-semibold">Hướng dẫn</span>
                    </button>
                </div>
            </div>
        </aside>
